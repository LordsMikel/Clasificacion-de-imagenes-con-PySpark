...
assembler = VectorAssembler(inputCols=["image.width", "image.height", "image.nChannels", "features"],
                            outputCol="caracteristicas")
train = assembler.transform(train)
test = assembler.transform(test)

# Crear un modelo de Random Forest
rf = RandomForestClassifier(labelCol="label", featuresCol="caracteristicas", numTrees=10)
